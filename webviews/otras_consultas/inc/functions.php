...
/**
 * Crea y escribe archivos de logs. Tambíen hace el envío de las palabras al hilo.
 *
 * @param [type] $cod_error Código de error.
 * @param [type] $error Mensaje de error.
 * @param boolean $send True si se quiere mandar la palabra al hilo False si no se quiere mandar la palabra.
 * @return void
 */
