<?php
	...
	class FormularioModel {
		...
		public function updateFormulario($identificador, $fecha_fin, $apellidos, $nombres, $legajo, $importe_acreditar) {
			try {
				$this->conn->setAttribute();

				$this->conn->beginTransaction();

				$sql = "UPDATE " . TB_FORMULARIO . " set fecha_fin = '$fecha_fin', apellidos = '$apellidos', nombres = '$nombres', legajo = '$legajo', importe_acreditar = '$importe_acreditar' WHERE identificador = '$identificador' ORDER BY id DESC LIMIT 1";
