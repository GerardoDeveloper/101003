...
<head>
    ...
    <title>Formulario Solicitud Adelanto</title>
    ...
    <div class="container">
        <div class="content-wrapper" style="margin-top:-32px;">
            ...
            <form id="formData" class="form-wrapper">
                ...
                <div class="control-wrapper">
                    <input type="text" name="legajo" id="legajo" placeholder="Legajo" class="form-control" autocomplete="off" required>
                </div>

                <div class="control-wrapper">
                    <input type="text" name="importe_acreditar" id="importe_acreditar" placeholder="Importe a acreditar" class="form-control" autocomplete="off" required>
                </div>                
            </form>
            ...
            <div class="buttons-wrapper">
                <div class="control-wrapper">
                    ...
                    <button id="btnVolver" class="button luvi-secondary-button form-control" type="button">Volver</button>
